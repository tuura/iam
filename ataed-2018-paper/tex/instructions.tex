...
\hs{Jump 42} instructions\protect\footnotemark.}
\end{figure}
\vspace{-2em}
\footnotetext{We used the algebraic-graphs
Haskell library~\cite{Mokhov:2017:AGC:3156695.3122956} to implement an automated
visualiser of data dependencies.}
