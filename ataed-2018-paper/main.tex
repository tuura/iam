...
\begin{abstract}
This paper presents an approach to obtaining \emph{concurrency oracles} for
...
\and instuction set architecture
...
\input{tex/metalanguage.tex}

\section{Concurrency oracles for programs}
